...
(function(root, factory) {
  ...
  var KEYWORDS = {
    ...
    Specialized: 'Counts twice when a Contract counts cards of its type, and carries or produces 1 extra Goods.',
  ...
  var GLOBAL_RULES = [
    ...
    'You win by reaching 10 Fulfillment Points, or when your opponent\'s Supply Chain Health reaches 0.',
    'If you must draw a card and your deck is empty, you lose the game.',
    'Opening hand is 7 cards. Draw 2 cards in your Draw step; the player going first skips their first Draw step.',
    'Hand limit is 7 cards. Discard down to 7 during your End Step.',
    'Upkeep income: take 2 Capital plus 1 resource of your choice, before Infrastructure produces.',
    ...
    'Combat: attackers exhaust. The defender may block with any Workforce that did not attack, or with an untapped Fleet acting as a barricade (Power 0, Toughness equal to its Capacity).',
    ...
    'A card that arrived this turn is Arriving: it cannot attack or use a Tap ability unless it has Rush.',
