...
var OPERATIONS = {
  ...
  '153': [{ do: 'cargoDiscount', amount: 2 }, { do: 'fp', amount: 1 }],
...
var DISRUPTIONS = {
  '161': { cost: c(0, 1), effects: [{ do: 'disable', what: 'Fleet', who: 'opponent', count: 1, turns: 2 }] },
  '162': { cost: c(0, 0, 2), effects: [{ do: 'disable', what: 'Fleet', who: 'opponent', count: 2, turns: 2 }] },
  '163': { cost: c(0, 0, 0, 2), effects: [{ do: 'disable', what: 'Infrastructure', who: 'opponent', count: 2, turns: 1 }, { do: 'loseGoods', amount: 2, who: 'opponent' }] },
  '164': { cost: c(2), effects: [{ do: 'drain', resource: 'Capital', amount: 3, who: 'opponent' }] },
  '165': { cost: c(0, 0, 1), effects: [{ do: 'drain', resource: 'Fuel', amount: 2, who: 'opponent' }] },
  '166': { cost: c(0, 0, 0, 0, 1), effects: [{ do: 'loseGoods', amount: 2, who: 'opponent' }] },
  '167': { cost: c(0, 0, 1, 0, 1), effects: [{ do: 'destroy', what: 'Fleet', who: 'opponent', count: 1 }] },
  '168': { cost: c(0, 0, 0, 1), effects: [{ do: 'loseGoods', amount: 4, who: 'opponent' }] },
  '169': { cost: c(0, 0, 0, 0, 2), effects: [{ do: 'destroy', what: 'Infrastructure', who: 'opponent', count: 1 }] },
  '170': { cost: c(0, 0, 0, 1), effects: [{ do: 'drain', resource: 'Capital', amount: 3, who: 'opponent' }] },
  '171': { cost: c(0, 2, 0, 0, 1), effects: [{ do: 'disable', what: 'Workforce', who: 'opponent', count: 3, turns: 2 }] },
  '172': { cost: c(0, 0, 0, 0, 1), effects: [{ do: 'discard', amount: 2, who: 'opponent' }] },
  '173': { cost: c(0, 1), effects: [{ do: 'disable', what: 'Fleet', who: 'opponent', count: 2, turns: 1 }] },
  '174': { cost: c(0, 0, 0, 0, 1), effects: [{ do: 'loseGoods', amount: 2, who: 'opponent' }, { do: 'drain', resource: 'Capital', amount: 1, who: 'opponent' }] },
  '175': { cost: c(0, 0, 1, 0, 1), effects: [{ do: 'destroy', what: 'Infrastructure', who: 'opponent', count: 1 }] },

  '176': { cost: c(0, 0, 0, 0, 2), effects: [{ do: 'disable', what: 'Fleet', who: 'opponent', count: 2, turns: 2 }] },
  '177': { cost: c(0, 0, 0, 1), effects: [{ do: 'loseGoods', amount: 2, who: 'opponent' }] },
  '178': { cost: c(0, 0, 0, 2, 2), effects: [{ do: 'mill', amount: 3, who: 'both' }, { do: 'drain', resource: 'all', amount: 2, who: 'both' }, { do: 'damage', amount: 2 }] },
  '179': { cost: c(0, 0, 0, 2), effects: [{ do: 'drain', resource: 'all', amount: 1, who: 'opponent' }] },
  '180': { cost: c(0, 0, 0, 1), effects: [{ do: 'disable', what: 'Infrastructure', who: 'opponent', count: 1, turns: 2 }, { do: 'drain', resource: 'Data', amount: 1, who: 'opponent' }] },
  '181': { cost: c(0, 0, 0, 0, 2), effects: [{ do: 'destroy', what: 'Infrastructure', who: 'opponent', count: 1 }, { do: 'loseGoods', amount: 2, who: 'opponent' }] },
  '182': { cost: c(0, 2), effects: [{ do: 'disable', what: 'Workforce', who: 'opponent', count: 2, turns: 2 }] },
  '183': { cost: c(0, 0, 0, 3), effects: [{ do: 'disable', what: 'Infrastructure', who: 'opponent', count: 3, turns: 2 }] },
  '184': { cost: c(0, 0, 2, 0, 2), effects: [{ do: 'destroy', what: 'Infrastructure', who: 'opponent', count: 1 }, { do: 'destroy', what: 'Fleet', who: 'opponent', count: 1 }, { do: 'mill', amount: 2, who: 'both' }] },
  '185': { cost: c(0, 0, 0, 0, 3), effects: [{ do: 'destroy', what: 'Infrastructure', who: 'both', count: 1, pick: 'highestCost' }, { do: 'destroy', what: 'Fleet', who: 'both', count: 1, pick: 'highestCapacity' }] }
};
...
var CONTRACTS = {
  ...
  '187': { cost: c(0,1,0,0,1), requirements: { fleetCards: 1, fleetCapacity: 4, infrastructureSubtypes: ['Hub'] }, cargo: 3, fpReward: 2 },
  '188': { cost: c(1,0,1), requirements: { fleetCards: 1, fleetCapacity: 3, fleetSubtypes: ['Vehicle'], infrastructureSubtypes: ['Storage'] }, cargo: 3, fpReward: 3 },
  '189': { cost: c(0,0,0,1), requirements: { fleetCards: 2 }, cargo: 2, fpReward: 2 },
  '190': { cost: c(1,1), requirements: { fleetCards: 1, fleetCapacity: 5, fleetSubtypes: ['Vehicle'], workforce: 2 }, cargo: 4, fpReward: 3 },
  '191': { cost: c(1,1), requirements: { fleetCards: 1, fleetSpeed: 2, workforceSubtypes: ['Specialist'] }, cargo: 2, fpReward: 2 },
  '192': { cost: c(1,0,0,1), requirements: { fleetCards: 1, fleetCapacity: 4, fleetSubtypes: ['Air'], infrastructureSubtypes: ['Digital'] }, cargo: 3, fpReward: 3 },
  '193': { cost: c(1), requirements: { fleetCards: 1 }, cargo: 1, fpReward: 2 },
  '194': { cost: c(0,0,0,1), requirements: { fleetCards: 1, fleetSpeed: 2, infrastructureSubtypes: ['Storage'] }, cargo: 2, fpReward: 2 },
  '195': { cost: c(0,1,1), requirements: { fleetCards: 1, fleetCapacity: 3, fleetSubtypes: ['Ship'], workforce: 2 }, cargo: 3, fpReward: 3 },
  '196': { cost: c(1,0,1,1), requirements: { fleetCards: 1, fleetSpeed: 4, infrastructureSubtypes: ['Hub'] }, cargo: 3, fpReward: 4 },
  '197': { cost: c(0,1,0,1,1), requirements: { fleetCards: 1, fleetCapacity: 5, fleetSubtypes: ['Rail'], infrastructureSubtypes: ['Facility'], workforce: 3 }, cargo: 4, fpReward: 4 },
  '198': { cost: c(1,0,1,1), requirements: { fleetCards: 2, fleetSpeed: 3, fleetSubtypes: ['Air'], infrastructureSubtypes: ['Storage', 'Hub'] }, cargo: 4, fpReward: 4 },
  '199': { cost: c(1,1,0,1), requirements: { fleetCards: 3, fleetCapacity: 8, workforce: 4 }, cargo: 5, fpReward: 5 },
  '200': { cost: c(2,1,0,1,1), requirements: { fleetCards: 2, fleetSubtypes: ['Vehicle', 'Ship', 'Air'], infrastructureSubtypes: ['Facility', 'Storage', 'Hub', 'Digital'], workforce: 5 }, cargo: 5, fpReward: 6 }
};
